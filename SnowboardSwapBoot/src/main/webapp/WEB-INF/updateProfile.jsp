...
<!--         </div> -->
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="postalCode" name="postalCode" value="${user.address.postalCode}">
        </div>
        <div class="form-group">
            <label for="phoneNumber">Phone Number</label>
            <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value="${user.address.phoneNumber}">
        </div>
        <!-- Add more fields as needed -->
        
        <!-- Cancel/Update Button -->
        <a href="profile" class="btn btn-secondary" data-toggle="tooltip" title="Cancel and return to the profile page">Cancel</a>
        <button type="submit" class="btn btn-primary" data-toggle="tooltip" title="Update Profile">Confirm Edit</button>
    </form>
</div>
